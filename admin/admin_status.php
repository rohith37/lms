...
<div class="container">
	...
	<?php
		...
		echo "</table>";
		   ?>
		   <form method="post">
            <button type="submit" name="submit1" style="background-color: black; color: red;" class="btn btn-default"><span style="color: red;" class="glyphicon glyphicon-remove-sign">&nbspRemove</span></button>
            <button type="submit" name="submit2" style="background-color: black; color: green;" class="btn btn-default"><span style="color: green;" class="glyphicon glyphicon-ok-sign">&nbspApprove</span></button>
		   </form>
		   <?php
